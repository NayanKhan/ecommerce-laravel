...
<!-- All District Management Menu Ends -->
  ...
  <!-- All Pages Menu Start -->
  <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info">Pages</label>
  ...
  <li class="br-menu-item">
    ...
    <ul class="br-menu-sub">
      ...
      <li class="sub-item"><a href="{{route('slider.create')}}" class="sub-link">Create New Slider</a></li>
    </ul>
  </li>
  <!-- All Pages Menu Ends -->

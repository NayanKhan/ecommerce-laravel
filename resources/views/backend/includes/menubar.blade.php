   ...
   <label class="sidebar-label pd-x-10 mg-t-25 mg-b-20 tx-info">Education Department</label>
    ...
    <li class="br-menu-item">
      ...
      <ul class="br-menu-sub">
        <li class="sub-item"><a href="" class="sub-link">Manage All Branch</a></li>
        <li class="sub-item"><a href="" class="sub-link">Create New Branch</a></li>
      </ul>
    </li>
    ...
    <li class="br-menu-item">
      ...
      <ul class="br-menu-sub">
        <li class="sub-item"><a href="" class="sub-link">Manage All Course</a></li>
        <li class="sub-item"><a href="" class="sub-link">Create New Course</a></li>
      </ul>
    </li>

                ...
                <div class="row">
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="code" class="form-control" autocomplete="off" required="required">
                    </div>
                  ...
                  <div class="col-lg-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="percent_value" class="form-control">
                    </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="form-group">
                      <input type="submit" name="addCoupon" class="btn btn-teal m-b-10" value="Add New Coupon">
                    </div>
                  </div>
                </div>

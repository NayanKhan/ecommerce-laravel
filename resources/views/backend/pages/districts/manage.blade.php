...
<div class="br-pagetitle">
    ...
    <div>
    <h4>Manage All The District Information</h4>
            ...
            <div class="bd bd-gray-300 rounded table-responsive">
                    ...
                    <tbody>
                        ...
                        <td>
                            <ul class="custom-action">
                                ...
                                <li><a href="" data-toggle="modal" data-target="#district{{ $district->id }}"><i class="fa fa-trash"></i></a></li>
                            </ul>
                        </td>
                        <!-- Delete Modal Start -->
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title text-center" id="exampleModalLabel">Do You Confirm to Delete This district?</h5>
                ...
                @if ($districts->count()== 0 )
                    <div class="alert alert-info">
                        No. District Added Yet. Please Add a District First.
                    </div>
                @endif
            </div>
